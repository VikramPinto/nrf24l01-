...
static uint8_t          tx[2], txx[6],txxx[16];
static uint8_t          rx[2], rxx[6], rxxx[16];
char 			da1, da2, da3, da4, da5, da6, da7, da8, *dp, *txdata;
int			ch_no, i, j, fd, fd2;
FILE 			*fd3 = NULL, *fd4 = NULL;
